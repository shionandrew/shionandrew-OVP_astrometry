...
if __name__=='__main__': 
    ...
    parser.add_argument("--tel", help=" )", type=str,default='gbo')
    parser.add_argument("--tag", help=" )", type=str,default='M22_true_pos_fit')
    ...
    fmin=cmdargs.fmin
    fmax=cmdargs.fmax
    inputtag=cmdargs.tag
    inputtag=f'{inputtag}_{tel2}'
